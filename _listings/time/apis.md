...
- type: x-contact-form
  url: http://aphelp.ap.org/ContactUs/
- type: x-crunchbase
  url: https://crunchbase.com/organization/time-2
- type: x-crunchbase
  url: https://crunchbase.com/organization/associated-press
- type: x-crunchbase
  url: http://www.crunchbase.com/company/associated-press
- type: x-crunchbase
...
- type: x-email
  url: feedback@time.com
- type: x-email
  url: mediarelations@ap.org
- type: x-email
  url: info@ap.org
- type: x-email
  url: leaston@ap.org
- type: x-email
  url: APCustomerSupport@ap.org
- type: x-email
...
- type: x-explorer
  url: https://developer.ap.org/api-console
- type: x-faq
  url: http://customersupport.ap.org/api/Help/index.htm
- type: x-free-trial
  url: http://www.aptn.com/80256FE80050E128/httpTrial?OpenForm&section=news&subsection=news
- type: x-github
...
- type: x-python-library
  url: https://github.com/TheAssociatedPress/APISamples/tree/master/APContentAPI/python
- type: x-ruby-library
  url: https://github.com/TheAssociatedPress/APISamples/tree/master/APContentAPI/ruby
- type: x-selfservice-registration
  url: http://www.aptn.com/80256FE40039EB88/httpmyAccountRegister?OpenForm&url=http://www.aptn.com/80256FE80050E128/httpTrial?OpenForm&section=news&subsection=news
- type: x-twitter
  url: https://twitter.com/TIME
- type: x-twitter
