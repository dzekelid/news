...
created: "2018-06-25"
modified: "2018-06-25"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/news/master/_listings/npr/apis.md
...
- name: NPR Show a web-based login/signup form to a user
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/news/master/_listings/npr/authorizationv2authorize-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/news/master/_listings/npr/authorizationv2authorize-get-openapi.md
- name: NPR Initiate an OAuth2 login flow for limited input devices
  ...
  properties:
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/news/master/_listings/npr/authorizationv2device-post-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/news/master/_listings/npr/authorizationv2device-post-openapi.md
- name: NPR Create a new OAuth2 access token
  ...
  properties:
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/news/master/_listings/npr/authorizationv2token-post-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/news/master/_listings/npr/authorizationv2token-post-openapi.md
- name: NPR Revoke an existing OAuth2 access token
  ...
  properties:
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/news/master/_listings/npr/authorizationv2tokenrevoke-post-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/news/master/_listings/npr/authorizationv2tokenrevoke-post-openapi.md
- name: NPR Update the following status of the logged-in user for a particular aggregation
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/news/master/_listings/npr/identityv2following-post-openapi.md
- name: NPR Update the logged-in user's favorite station(s)
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/news/master/_listings/npr/identityv2stations-put-openapi.md
- name: NPR Get the latest state information about the logged-in user
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/news/master/_listings/npr/identityv2user-get-openapi.md
- name: NPR Copy listening data from a temporary user account to the logged-in user's
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/news/master/_listings/npr/identityv2userinherit-post-openapi.md
- name: NPR Get a set of recommendations for an aggregation
  ...
  properties:
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/news/master/_listings/npr/listeningv2aggregationaggidrecommendations-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/news/master/_listings/npr/listeningv2aggregationaggidrecommendations-get-openapi.md
- name: NPR Get the list of available channels
  ...
  properties:
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/news/master/_listings/npr/listeningv2channels-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/news/master/_listings/npr/listeningv2channels-get-openapi.md
- name: NPR Get recent ratings the logged-in user has submitted
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/news/master/_listings/npr/listeningv2history-get-openapi.md
- name: NPR Get a list of recommendations from a category of content from an organization
  ...
  properties:
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/news/master/_listings/npr/listeningv2organizationsorgidcategoriescategoryrecommendations-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/news/master/_listings/npr/listeningv2organizationsorgidcategoriescategoryrecommendations-get-openapi.md
- name: NPR Get a variety of details about an organization including various lists
  ...
  properties:
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/news/master/_listings/npr/listeningv2organizationsorgidrecommendations-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/news/master/_listings/npr/listeningv2organizationsorgidrecommendations-get-openapi.md
- name: NPR Retrieve the most recent promo audio heard by the logged-in user
  ...
  properties:
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/news/master/_listings/npr/listeningv2promorecommendations-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/news/master/_listings/npr/listeningv2promorecommendations-get-openapi.md
- name: NPR Collect new ratings for media previously recommended to the logged-in
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/news/master/_listings/npr/listeningv2ratings-post-openapi.md
- name: NPR Get a list of media for the logged-in user from NPR's recommendation engine
  ...
  properties:
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/news/master/_listings/npr/listeningv2recommendations-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/news/master/_listings/npr/listeningv2recommendations-get-openapi.md
- name: NPR Get a list of recent audio and aggregation items associated with search
  ...
  properties:
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/news/master/_listings/npr/listeningv2searchrecommendations-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/news/master/_listings/npr/listeningv2searchrecommendations-get-openapi.md
- name: NPR Send a donation email to the logged-in user (only on request)
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/news/master/_listings/npr/localactivationv2donate-email-get-openapi.md
- name: NPR Request DAAST sponsorship units
  ...
  properties:
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/news/master/_listings/npr/sponsorshipv2ads-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/news/master/_listings/npr/sponsorshipv2ads-get-openapi.md
- name: NPR Record tracking data for DAAST sponsorship units
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/news/master/_listings/npr/sponsorshipv2ads-post-openapi.md
- name: NPR List stations close to you or filter by search criteria
  ...
  properties:
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/news/master/_listings/npr/stationfinderv3stations-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/news/master/_listings/npr/stationfinderv3stations-get-openapi.md
- name: NPR Retrieve metadata for the station with the given numeric ID
  ...
  properties:
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/news/master/_listings/npr/stationfinderv3stationsstationid-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/news/master/_listings/npr/stationfinderv3stationsstationid-get-openapi.md
- name: NPR
  x-api-slug: npr
  description: NPR delivers breaking national and world news. Also top stories from
    business, politics, health, science, technology, music, arts and culture. Subscribe
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/news/master/_listings/npr/openapi.md
x-common:
- type: x-base
